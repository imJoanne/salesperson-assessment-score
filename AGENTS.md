# salesperson-assessment-score

Self-liquidating lead-gen assessment app that scores salespeople, generates gap reports with product recommendations, and logs purchases.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "316898186+imJoanne@users.noreply.github.com"
  git config user.name "imJoanne"
  ```
